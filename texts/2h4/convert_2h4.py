...
class Converter:
    ...
    def handle_edition(self, el):
        ...
        for child in el:
            ...
            if child.attrib["n"] in ["cast", "induction", "epilogue"]:
                pass  # ignore cast list, induction for now
...
if __name__ == "__main__":
    c = Converter()
    filename = CANONICAL_ENGLIT / "data/shakespeare/2h4.xml"
    with open("2h4-text.tsv", "w") as text_fd, open("2h4-anno.jsonl", "w") as anno_fd:
